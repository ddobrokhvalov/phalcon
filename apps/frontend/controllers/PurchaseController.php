...
class PurchaseController extends Controller
{
    ...
    public function getAction()
    {
		...
		$xml_data = $purchase->getUrl2("http://apis.multitender.ru/gospartner/getInfoByPurchaseNumber44?purchaseNumber=".$auction_id."&apikey=Xoh2liehai8Shoo4Gie1duoG8Iex7sea&format=xml");
		
		if(!$xml_data/* || (is_string($xml_data) && strstr($xml_data, "error"))*/){
			$data = $purchase->parseAuction($auction_id);
		}else{
