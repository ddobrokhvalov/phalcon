...
// +----------------------------------------------------------------------+
//
// $Id: vlibMimeMail.php,v 1.2 2008/07/30 08:32:25 dkonstantinov Exp $
...
if (!defined('vlibMimeMailClassLoaded')) {
    ...
    \-----------------------------------------------------------------------------*/
         ...
         * charset.
         *  i.e. $mail->body('ce message est en franзais.', 'iso-8859-1');
         *
         ...
         * If you're sending a mail with special characters, be sure to define the
         * charset.
         *  i.e. $mail->htmlbody('ce message est en franзais.', 'iso-8859-1');
         *
