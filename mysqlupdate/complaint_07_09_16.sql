...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 07 2016 г., 15:02
...
CREATE TABLE IF NOT EXISTS `complaint` (
  ...
  `nachalo_podachi` varchar(20) DEFAULT NULL,
  `okonchanie_podachi` varchar(20) DEFAULT NULL,
  `vskrytie_konvertov` varchar(20) DEFAULT NULL,
  `data_rassmotreniya` varchar(20) DEFAULT NULL,
  `data_provedeniya` varchar(20) DEFAULT NULL,
  `okonchanie_rassmotreniya` varchar(20) DEFAULT NULL,
  `vremya_provedeniya` varchar(20) DEFAULT NULL,
  `ufas_id` int(11) DEFAULT NULL
